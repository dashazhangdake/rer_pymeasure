...
class b1505a(AgilentB1500): # Overriden Skeleton B1505
    ...
    def query_modules(self):
        ...
        module_names = {
            # 'B1525A': 'SPGU', # No 'SPGU' in B1505A
            # 'B1517A': 'HRSMU', # No 'HRSMU' in B1505A
            # 'B1511B': 'MPSMU', # RER setup doesn't use MPSMU for now
            # 'B1514A': 'MCSMU', # RER setup doesn't use MCSMU for now
            '0': 'GNDU+ADC', # terminal 0
            'B1510A': 'HPSMU', # terminal 1 or 3 ?
